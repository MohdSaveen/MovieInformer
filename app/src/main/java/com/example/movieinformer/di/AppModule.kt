...
import com.example.movieinformer.data.repository.SearchMovieRepositoryImpl
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideSearchingMoviesDao(movieDb: MovieDatabase) : SearchMoviesDao{
        return movieDb.searchDao
    }

    @Singleton
    @Provides
    fun provideSearchingRemoteKeys(movieDb: MovieDatabase) : SearchRemoteKeysDao{
        return movieDb.searchRemoteKeysDao
    }
    ...
    @Provides
    @Singleton
    fun provideSearchMovieRepository(movieApi: MovieApi, movieDb: MovieDatabase) : SearchMovieRepository{
        return SearchMovieRepositoryImpl(movieApi,movieDb)
    }
